...
return {
    ...
    dependencies = {
        "folke/snacks.nvim", -- Snacks is used for the session lens
    },
    keys = {
        keymaps_helpers.make_lazy(
            keymaps.auto_session.open_session_lens,
    ...
    opts = {
        ...
        auto_create = function() -- Enables/disables auto creating new session files. Can take a function that should return true/false if a new session file should be created or not
        ...
        session_lens = {
            ...
            mappings = {
                -- TODO: Add this in the keymap, too lazy tho
